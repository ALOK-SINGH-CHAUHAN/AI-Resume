...
class DeepRAGAcceptanceTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.chroma_dir = os.path.join(cls.data_dir, "test_deep_chroma_db")
    ...
    def test_04_unsupported_experience_hallucination(self):
        ...
        self.assertTrue("couldn't find" in ans or "no" in ans or "does not establish" in ans or "insufficient" in ans)
    ...
    def test_07_unknown_domain_questions(self):
        ...
        ans = res["answer"].lower()
        self.assertTrue("couldn't find" in ans or "no" in ans or "insufficient" in ans)
    ...
    def test_10_candidate_isolation(self):
        ...
        citations = res["evidence_citations"]
        # Candidate A (Alok) has no React; citations should not mix Priya's resume
        for c in citations:
    ...
    def test_15_related_competency_consistency(self):
        ...
        # Verify matched_required, hard_gaps, related_competencies don't double count
